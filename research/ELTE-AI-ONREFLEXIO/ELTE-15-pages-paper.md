...
Supplementary analysis of concerns confirmed the standalone hypothesis that misinformation risk is a greater concern than emotional dependency: 59.5% of respondents cited misleading or false information as a concern, compared to 42.9% for over-reliance, 38.9% for loss of human connection, and 31.7% for emotional dependency. Only 11.9% reported no concerns. This epistemic vigilance about AI accuracy, combined with the trust findings above, paints a picture of a sample that is neither naively credulous nor uniformly skeptical — but selectively critical, applying higher scrutiny to AI outputs that feel wrong than to those that feel coherent.
