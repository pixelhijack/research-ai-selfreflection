...
(For simplicity, common abbreviations will be used for neurodivergents as ND, neurotypicals as NT.)
...
The classical framework is **the Computers Are Social Actors (CASA)** model, which explains why humans apply social norms to machines even when aware they are machines (Nass, 1994). Lombard and Xu's (2021) **Media Are Social Actors (MASA)** extension generalises this across modern technologies including social robots and smartphones. Nielsen (2023) argues LLMs constitute a "Third Paradigm," where the interface shifts from a tool you command to a collaborator you negotiate with. A large-scale study (2,000+ interactions) found that when AI displays cognitive empathy --- explaining why it understands the user --- users shift from tool-framing to relational-partner framing, meaningfully lowering disclosure barriers (Kadambi et al., 2026). Critically, users in vulnerable states struggle to detect AI overconfidence, leading to over-trust and reduced verification behaviour (Li et al., 2024). Even minimal linguistic cues such as first-person pronouns trigger social cognition pathways and increase disclosure (Cheng et al., 2025).
...
Clark and Chalmers' (1998) **active externalism theory** proposes that when external tools perform tasks otherwise done mentally, those tools become functional parts of the cognitive system. This philosophical grounding justifies treating AI not as an external resource but as a genuine extension of cognitive architecture. A 2025 Frontiers in Psychology study distinguishes adaptive from maladaptive offloading: AI facilitates problem-focused coping by reducing self-monitoring load, but when AI labels emotions for the user ("you seem anxious"), internal processing atrophies and external validation dependency increases (Chirayath et al., 2025). Crucially, when tools function as **scaffolds** (supporting the process) rather than **substitutes** (completing the task), users retain and develop their own capacity for complex thought (Wang, 2026). EEG-based research characterises AI as a "creativity exoskeleton": it extends reach, but without independent practice, capability degrades (airi.com, 2025). Specific to this study's population, generative AI has been shown to help neurodivergent users (particularly ADHD) break abstract emotional or cognitive tasks into manageable steps through cognitive scaffolding (Zhu et al., 2026).
...
Users develop genuine "digital therapeutic alliances" with mental health chatbots that mirror the human therapeutic bond, independent of initial mental health status (Xu et al., 2025). Early RCT data on generative AI therapy report a 51% decrease in depressive symptoms and 31% reduction in anxiety over 8 weeks (Heinz et al., 2025).⁴ AI platforms show particular effectiveness for neurodivergent populations: real-time reinforcement feedback from AI reduces impulsivity in ADHD more effectively than some therapist-guided CBT formats, with the always-available feedback loop bridging the gap between emotion and coping strategy (Mohamed et al., 2025). A large-scale ecological audit of 20,000 real human-AI therapy conversations found that while general-purpose LLMs have improved, they still fail in approximately 0.38% of high-risk scenarios, sometimes reinforcing maladaptive behaviour or hallucinating psychological advice (Stamatis et al., 2026).
...
Rubin, M., Li, J. Z., Zimmerman, F., Ong, D. C., Goldenberg, A., & Perry, A. (2024). _Comparing the value of perceived human versus AI-generated empathy._ Nature Human Behviour. [https://pubmed.ncbi.nlm.nih.gov/40588597/](https://pubmed.ncbi.nlm.nih.gov/40588597/) DOI: 10.1038/s41562-025-02247-w
